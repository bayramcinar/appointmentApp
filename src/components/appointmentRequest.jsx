          ...
          <div className="relative w-[430px] max-[768px]:w-[375px] p-5 bg-white rounded-2xl animate__animated animate__zoomIn">
            <div className="flex items-center justify-center relative">
              <div className='titleModal m-3'>
                <h1 className='text-center text-xl mr-auto ml-auto w-full mb-0'>Randevu Talebi</h1>
              </div>
            ...
            <div>
              <div className='appointmentRequestArea'>
                <h1 className='text-buttonColor text-sm text-center font-semibold'>Lütfen Aşağıdan oluşturmak istediğiniz randevu talebi saati seçiniz</h1>
                <Formik
                  initialValues={{
                    time: ""
                  }}
                ...
                >
                  <Form id="appRequest" className='flex flex-col items-center justify-center'>
                    <div className='m-3'>
                      <Field
                        min={getCurrentTime()}
                        type='time'
                    ...
                    <button type="submit" className='bg-appoinmentBox rounded-2xl p-1 px-6 text-white text-sm mt-[15px]'>Talep Oluştur</button>
                  </Form>
                </Formik>
              </div>
            </div>
