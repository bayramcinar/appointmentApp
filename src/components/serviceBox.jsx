  ...
  return (
    <div>
      <div className='service max-[768px]:m-[13px] cursor-pointer flex rounded-2xl w-[14.5rem] max-[768px]:w-[16rem] m-[2px]' onClick={handleServiceClick}>
        <div className={`textArea md:rounded-r-3xl bg-buttonColor ${isSelected ? 'bg-white border-2 border-buttonColor ' : 'bg-buttonColor'} w-80 p-2 rounded-3xl flex items-center justify-center max-[768px]:rounded-2xl`}>
