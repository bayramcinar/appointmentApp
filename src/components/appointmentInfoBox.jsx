...
function AppointmentInfoBox({ number, title, changeRate }) {
  return (
    <div className="w-[8vw] h-[8vw] max-[768px]:w-[120px] max-[768px]:h-[120px] shadow-xl flex flex-col items-center bg-white justify-center  rounded-2xl m-[1.4vw] max-[500px]:m-[20px] relative">
      {changeRate > 0 && (
      ...
      <div className="infoArea w-[6vw] m-4 mb-0 max-[768px]:w-[15vw]">
        <h1
          className="number text-center text-[#000000a8] text-[3vw] max-[768px]:text-4xl font-semibold"
          style={{ fontFamily: "Montserrat, sans-serif" }}
        >
          {number}
        </h1>
      </div>
      <div className="titleArea h-1/2 m-[0.25rem] mb-5 max-[768px]:m-2 flex items-center justify-center mt-0">
        <h1 className="text-[0.8vw] text-center max-[768px]:text-sm font-medium">
          {title}
        </h1>
      </div>
    </div>
