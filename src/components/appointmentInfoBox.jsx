...
function AppointmentInfoBox({ number, title, changeRate }) {
  return (
    <div className="rounded-xl">
      <div
        className="w-[8vw] h-[8vw] max-[768px]:w-[120px] max-[768px]:h-[120px] shadow-lg flex flex-col items-center bg-white justify-center  rounded-2xl m-[1.4vw] max-[500px]:m-[20px] relative"
        style={{
          borderWidth: "4px",
          borderStyle: "solid",
          borderImage: "linear-gradient(to right, #ed145b, #6b2465)",
          borderImageSlice: 1,
        }}
      >
        {changeRate > 0 && (
