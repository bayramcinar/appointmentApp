...
function SetAppointmentTime() {
  ...
  return (
    <div className="ml-auto mr-auto bg-dayComponentBg mt-10 setAppointmentTime flex items-center justify-center flex-col lg:h-auto sm:h-auto shadow-xl border-stepBorder1 border-2 rounded-xl lg:min-h-[800px] relative p-[1vw] w-[auto] max-[768px]:p-2">
