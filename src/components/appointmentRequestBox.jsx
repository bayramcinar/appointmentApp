...
function AppointmentRequestBox({ image, infos, onDetails }) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        if (originalObje) {
          ...
          const updatedObje = { ...originalObje, time: updatedTimeObject };
  ...
  return (
    <>
      <div className="bg-white myAppointmentBox lg:w-[280px] h-[200px] max-[768px]:w-[300px] mb-5 ml-auto mr-auto border-2 border-buttonColor rounded-2xl shadow-2xl">
