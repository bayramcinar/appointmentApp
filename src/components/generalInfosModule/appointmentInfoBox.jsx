    ...
    <div className="border-gray-200 border-2 rounded-md bg-white lg:w-[11.5vw] m-1 2xl:m-3 w-44">
      <div
        className={`px-[0.3vw] py-[0.5vw] 2xl:px-[0.5vw] ${
          graph ? "2xl:py-[2vw]" : "2xl:py-[2.9vw]"
        } `}
      >
        <div className="titleArea flex justify-start m-1">
          <h1 className="text-sm lg:text-[0.8vw] text-deepSlateBlue font-semibold">
            {title}
          </h1>
        </div>
        <div className="rateArea flex justify-start m-1">
        ...
        <div className="lastRate flex text-gray-500 font-medium text-xs lg:text-[0.6vw] m-1">
        ...
        <div className="seeReport m-1">
          <h1
            className={`underline text-xs lg:text-[0.7vw] cursor-pointer ${
              graph ? "" : "hidden"
            }`}
            onClick={() => changeGraph()}
          >
