      ...
      <div className="bg-dayComponentBg">
        ...
        <div className="flex max-[768px]:block">
          <div className="flex justify-start bg-dayComponentBg pb-8 w-[100%]">
            <div className="w-[750px] ml-[9rem] max-[768px]:ml-[1.5rem] max-[768px]:w-[24rem] bg-dayComponentBg setAppointmentTime flex flex-col shadow-xl border-stepBorder1 border-2 rounded-xl">
        ...
        <div className="bg-dayComponentBg border-stepBorder1 border-2 rounded-xl mx-[9rem] max-[768px]:h-auto  max-[768px]:mx-[1.5rem] max-[768px]:w-[24rem] b-5">
